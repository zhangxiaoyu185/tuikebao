...
public class CoreWechatController extends BaseController {
	...
	*/
	 ...
	 * @param crwctProjectLogo 项目logo
	 * @param crwctProjectName 项目名称
	 * @param crwctProjectDesc 项目描述
	 * @param response
	 */
	@RequestMapping(value="/add/coreWechat", method=RequestMethod.POST)
	public void addCoreWechat (String crwctName, String crwctPic, String crwctAppid, String crwctAppsecret, String crwctPartner, String crwctPartnerkey, String crwctNotifyurl, String crwctRemarks,String crwctProjectLogo,String crwctProjectName,String crwctProjectDesc, HttpServletResponse response) {
		logger.info("[CoreWechatController]:begin addCoreWechat");

		if (StringUtil.isEmpty(crwctName)) {
			writeAjaxJSONResponse(ResultMessageBuilder.build(false, -1, "[公众号名称]不能为空!"), response);
			logger.info("[CoreWechatController]:end addCoreWechat");
			return;
		}
		if (StringUtil.isEmpty(crwctAppid)) {
			writeAjaxJSONResponse(ResultMessageBuilder.build(false, -1, "[appid]不能为空!"), response);
			logger.info("[CoreWechatController]:end addCoreWechat");
			return;
		}
		if (StringUtil.isEmpty(crwctAppsecret)) {
			writeAjaxJSONResponse(ResultMessageBuilder.build(false, -1, "[appsecret]不能为空!"), response);
			logger.info("[CoreWechatController]:end addCoreWechat");
			return;
		}
		...
		coreWechat.setCrwctPic(crwctPic);
		...
		coreWechat.setCrwctProjectLogo(crwctProjectLogo);
		coreWechat.setCrwctProjectName(crwctProjectName);
		coreWechat.setCrwctProjectDesc(crwctProjectDesc);
	...
	*/
	...
	public void updateCoreWechat (String crwctUuid, String crwctPic, String crwctAppid, String crwctAppsecret, String crwctPartner, String crwctPartnerkey, String crwctNotifyurl, String crwctRemarks,String crwctProjectLogo,String crwctProjectName,String crwctProjectDesc, HttpServletResponse response) {
