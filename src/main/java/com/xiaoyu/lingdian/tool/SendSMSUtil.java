...
public class SendSMSUtil {
	...
	public static void main(String[] args) throws Exception {
		sendShareRegister("http://apis.hzfacaiyu.com/sms/openCard", "3n1A4nMdVsTsRhjL", "15157135185", "5678", "chengkedz", "D2JwIPUS");
	}
	 ...
	 * @throws Exception 
	 */
	public static boolean sendShareRegister(String smsUrl, String smsKey, String mobileTel, String code, String loginname, String password) throws Exception {
		WebClient client = createClient(smsUrl);
		client.type("application/json;charset=UTF-8");
		Map<String, Object> params = new HashMap<String, Object>();	
		String tradeNo = AESUtil.getTradeNo();
		
		String content = "您在推客宝平台的注册验证码："+code+",十分钟内有效!";
		/**
		try {
	 ...
	 * @throws Exception 
	 */
	public static boolean sendStoreRegister(String smsUrl, String smsKey, String mobileTel, String code, String loginname, String password) throws Exception {
		WebClient client = createClient(smsUrl);
		client.type("application/json;charset=UTF-8");
		Map<String, Object> params = new HashMap<String, Object>();	
		String tradeNo = AESUtil.getTradeNo();
		
		String content = "您在推客商城平台的注册验证码："+code+",十分钟内有效!";
		/**
		try {
			content = URLEncoder.encode(content, "UTF-8");
		} catch (UnsupportedEncodingException e) {
	 ...
	 * @throws Exception 
	 */
	public static boolean sendStoreForgetPwd(String smsUrl, String smsKey, String mobileTel, String code, String loginname, String password) throws Exception {
		WebClient client = createClient(smsUrl);
		client.type("application/json;charset=UTF-8");
		Map<String, Object> params = new HashMap<String, Object>();	
		String tradeNo = AESUtil.getTradeNo();
		
		String content = "您在推客商城平台申请忘记密码的验证码是："+code+",十分钟内有效!";
		/**
		try {
			content = URLEncoder.encode(content, "UTF-8");
		} catch (UnsupportedEncodingException e) {
	 ...
	 * @throws Exception 
	 */
	public static boolean sendShareForgetPwd(String smsUrl, String smsKey, String mobileTel, String code, String loginname, String password) throws Exception {
		WebClient client = createClient(smsUrl);
		client.type("application/json;charset=UTF-8");
		Map<String, Object> params = new HashMap<String, Object>();	
		String tradeNo = AESUtil.getTradeNo();
		
		String content = "您在推客宝平台申请忘记密码的验证码是："+code+",十分钟内有效!";
		/**
		try {
			content = URLEncoder.encode(content, "UTF-8");
		} catch (UnsupportedEncodingException e) {
	...
	public static boolean sendCash(String smsUrl, String smsKey, String mobileTel, String code, String loginname, String password) throws Exception {
		...
		String content = "您在推客宝平台申请提现,申请验证码："+code+",十分钟内有效!";
		/**
		try {
			content = URLEncoder.encode(content, "UTF-8");
		} catch (UnsupportedEncodingException e) {
