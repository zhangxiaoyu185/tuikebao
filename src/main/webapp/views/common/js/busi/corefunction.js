...
$(function () {
	...
	$("body").delegate(".delit","click",function(){
		...
		if (r==true){
			...
			getOData(str,"coreFunction/delete/one",{fn:function(oData){
					var obj = {};//查询条件对象
					searchContent(obj);
					pagenum = parseInt($(".curpage").text());
					isNull(obj,pagenum);
	...
	$("body").delegate(".enablelit","click",function(){
		...
		if (r==true){
			...
			getOData(str,"coreFunction/enable",{fn:function(oData){
					var obj = {};//查询条件对象
					searchContent(obj);
...
function showList(obj,pagenum){
	...
	getOData(str,"coreFunction/find/by/cnd",{fn:function(oData){
		var strhtml_list = "";
