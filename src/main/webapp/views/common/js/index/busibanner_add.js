...
function Add(msgObject){
	...
	var str = 'bsbarLink='+encodeURIComponent(bsbarLink)+'&bsbarPic='+encodeURIComponent(bsbarPic)+'&bsbarOrd='+encodeURIComponent(bsbarOrd)+'&bsbarDesc='+encodeURIComponent(bsbarDesc)+'&bsbarShow='+encodeURIComponent(bsbarShow);
