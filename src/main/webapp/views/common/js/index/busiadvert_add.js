...
function Add(msgObject){
	...
	var str = 'bsaetLink='+encodeURIComponent(bsaetLink)+'&bsaetPic='+encodeURIComponent(bsaetPic)+'&bsaetOrd='+encodeURIComponent(bsaetOrd)+'&bsaetDesc='+encodeURIComponent(bsaetDesc);
