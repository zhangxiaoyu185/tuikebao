...
function getInfo(id){
	...
	getOData(str,"busiServerDynamic/views",{fn:function(oData){
		if(oData.code == 1) {
			$(".bssdcType").val(oData.data.bssdcType || "");
			$(".bssdcTitle").val(oData.data.bssdcTitle || "");
			$(".bssdcDesc").val(oData.data.bssdcDesc || "");
			CKEDITOR.instances.bssdcContent.setData(oData.data.bssdcContent);
			upImgItem.changeShow('img_upload_pic', 'bssdcPic', oData.data.bssdcPic, 702, 320, '10', '10', '702X320', function(widget) {
...
function Modify(msgObject){
	...
	var bssdcUuid = getQueryString("id");
	var bssdcType = $(".bssdcType").val();
	var bssdcTitle = $(".bssdcTitle").val();
	var bssdcPic = $(".bssdcPic").attr('data-uuid');
	var bssdcDesc = $(".bssdcDesc").val();
	var str = 'bssdcUuid='+encodeURIComponent(bssdcUuid)+'&bssdcType='+encodeURIComponent(bssdcType)+'&bssdcTitle='+encodeURIComponent(bssdcTitle)+'&bssdcPic='+encodeURIComponent(bssdcPic)+'&bssdcContent='+encodeURIComponent(bssdcContent)+'&bssdcDesc='+encodeURIComponent(bssdcDesc);
	getOData(str,"busiServerDynamic/update/busiServerDynamic",{
		fn:function(oData){
