...
<script type="text/javascript" src="<%=basePath%>views/js/jquery.js"></script>
<script type="text/javascript" src="<%=basePath%>views/js/jquery-form.js"></script>
